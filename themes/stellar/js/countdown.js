...
$.fn.countdown = function( method /*, options*/ ) {
	...
	var defaults = {
			date: null,
			updateTime: 1000,
			htmlTemplate: "<span class='t_day' title='Day(s)'>%d</span>:<span class='t_hour' title='Hour(s)'>%h</span>:<span  class='t_min' title='Minute(s)'>%i</span>:<span  class='t_sec'  title='Second(s)'>%s</span>",
			minus: false,
			onChange: null,
			onComplete: null,
			offSet: 0,
		...
		timerFunc = function() {
			...
			template = settings.concat + settings.htmlTemplate;
			var d = new Date();
