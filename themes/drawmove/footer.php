<?php if (!defined('FLUX_ROOT')) exit; ?>
                ...
                <div id="sidebar">
                    ...
                    <a href='https://discord.gg/JMvvGKA'><img class="imageButton" src='<?php echo $this->themePath('img/forum.png') ?>'/></a>
			...
			<div id="footer" style="background-image: url('<?php echo $this->themePath('img/bg.jpg'); ?>');">
				<div id="copyright">
					...
					<!-- DrawMove hidden box no-one will see, you can keep it if you accept to make us some hidden advertising =) -->
